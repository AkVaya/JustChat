...
public class ContactFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewContacts = inflater.inflate(R.layout.fragment_contact, container, false);
        recyclerViewContacts = viewContacts.findViewById(R.id.recyclerViewContacts);
                    ...
                    mRefUsers.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot2) {
                            ...
                            for(DataSnapshot temp : snapshot1.getChildren()) {
                                ...
                                contactsList.add(new Contacts(name, status, image, id,false,false,false));
                            }
